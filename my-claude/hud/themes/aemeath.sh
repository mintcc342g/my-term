...
GRAD_END_R=209;   GRAD_END_G=152;   GRAD_END_B=188

TITLE_BG_R=136; TITLE_BG_G=192; TITLE_BG_B=208
TITLE_FG_R=46;  TITLE_FG_G=52;  TITLE_FG_B=64
USER_BG_R=209;  USER_BG_G=152;  USER_BG_B=188
...
CSEG2_BG=(209 152 188);  CSEG2_FG=(46 52 64)      # branch — Nord15 bg
CSEG3_BG=(76 86 106);    CSEG3_FG=(209 152 188)   # model — Nord3 bg
