...
L_REQ_ALREADY="필수 도구(Homebrew·jq)가 이미 설치돼 있어 이 단계를 건너뜁니다."
...
L_PROMPT_NAME="이름: "
L_IDE_MORE_TITLE="IDE 설치 완료 — 계속할까요?"
L_IDE_ANOTHER="다른 IDE 설치"
L_IDE_PROCEED_FMT="다음 단계로 (%s)"
...
L_AI_METHOD_STABLE="Stable (안정 버전)"
L_AI_METHOD_LATEST="Latest (안정화 버전이 아닌 최신 버전)"
